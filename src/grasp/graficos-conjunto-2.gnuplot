...
plot 'resultadosTestConfiguracion-conjunto-2.txt' using 1:2 with lines notitle
...
#reset
#set terminal jpeg size 800,600
#set output "ejercicio-5-tiempos-grasp-dividido-n-conjunto-2.jpg"
#set key top left
#set yrange[0:]
#set xtics 5
#set xlabel "Cantidad de vértices (n)"
...
#plot 'tiemposGrasp-conjunto-2.txt' using 1:($2 / $1) title "Max. iter. = 100 | prof. vértice-conjunto = 2 2", \
#     'tiemposGrasp-conjunto-2.txt' using 1:($3 / $1) title "Max. iter. = 100 | prof. vértice-conjunto = 4 4", \
#     'tiemposGrasp-conjunto-2.txt' using 1:($4 / $1) title "Iter. sin mejora = 70 | prof. vértice-conjunto = 2 2", \
#     'tiemposGrasp-conjunto-2.txt' using 1:($5 / $1) title "Iter. sin mejora = 70 | prof. vértice-conjunto = 4 4"
#     
#reset
#set terminal jpeg size 800,600
